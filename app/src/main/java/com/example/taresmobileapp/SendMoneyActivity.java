...
public class SendMoneyActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    Toolbar toolbar;
    TextView addAccount;
    ImageButton continueBtn;
    RadioGroup radioAccountGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.money_naviguation_drawer);
        ...
        // Radios Values
        radioAccountGroup = findViewById(R.id.compte_groupe);
        radioAccountGroup.clearCheck();

        radioAccountGroup.setOnCheckedChangeListener((group, checkedId) -> {
            //RadioButton radioAccountButton = group.findViewById(checkedId);

            int selectedButtonId = radioAccountGroup.getCheckedRadioButtonId();
            RadioButton selectedRadioButton = radioAccountGroup.findViewById(checkedId);

            if (selectedButtonId == -1) {
                Toast.makeText(getApplicationContext(), "Aucun compte sélectionné", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(getApplicationContext(), "Compte d'envoi sélectionné : " + selectedRadioButton.getText(),
        ...
        // Buttons Values
        addAccount = findViewById(R.id.ajouter_un_compte);
