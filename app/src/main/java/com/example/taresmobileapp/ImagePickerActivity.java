...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Toast.makeText(getApplicationContext(), getString(R.string.toast_image_intent),
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
        String [] images = {context.getString(R.string.lbl_take_camera_picture),
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case UCrop.RESULT_ERROR:
                ...
                Log.e(TAG, "Erreur lors du choix: " + cropError);
                setResultCancelled();
                break;
