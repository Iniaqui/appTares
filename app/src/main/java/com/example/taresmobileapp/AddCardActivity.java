...
import com.example.taresmobileapp.helpers.CustomOnItemSelectedListener;
import com.google.android.material.navigation.NavigationView;

public class AddCardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cards_naviguation_drawer);

        // Add Toolbar and Action bar
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        // Spinner Adding Listener OnSpinnerItemSelection function
    ...
    public void addListenerOnSpinnerItemSelection() {
        ...
        // Spinner values
        Spinner currenciesSpinner = findViewById(R.id.currencies_spinner);
        // Getting selected values
        currenciesSpinner.setOnItemSelectedListener(new CustomOnItemSelectedListener());
    }
